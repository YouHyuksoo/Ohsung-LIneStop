      ...
      <div className="filter-section mb-8">
        ...
        <div className="mt-4 flex justify-end">
          <button
            ...
            className="px-6 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="stat-card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground mb-1">전체 불량 수</p>
              <p className="text-3xl font-bold">{filteredDefects.length}</p>
            </div>
        ...
        <div className="stat-card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground mb-1">불량 코드 수</p>
              <p className="text-3xl font-bold">
                {new Set(filteredDefects.map((d) => d.code)).size}
              </p>
            </div>
        ...
        <div className="stat-card">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground mb-1">오늘 발생</p>
              <p className="text-3xl font-bold">
                {
                  filteredDefects.filter(
                    (d) =>

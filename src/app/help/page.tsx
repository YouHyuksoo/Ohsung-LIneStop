      ...
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold mb-4 flex items-center gap-2">
            <Book className="w-6 h-6 text-[hsl(var(--primary))]" />
            시스템 개요
          </h2>
          ...
          <div className="bg-card border rounded-xl p-6 shadow-sm">
            <ol className="space-y-6">
              <li className="flex items-start gap-4">
                <div className="w-8 h-8 rounded-full bg-[hsl(var(--accent)/0.2)] text-[hsl(var(--accent))] flex items-center justify-center font-bold shrink-0">
                  1
                </div>
                <div>
              ...
              <li className="flex items-start gap-4">
                <div className="w-8 h-8 rounded-full bg-blue-500/20 text-[hsl(var(--primary))] flex items-center justify-center font-bold shrink-0">
                  2
                </div>
                <div>
                  ...
                  <div className="bg-[hsl(var(--primary)/0.1)] border border-[hsl(var(--primary)/0.2)] rounded p-3 text-sm">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <details className="bg-card border rounded-xl p-6 shadow-sm">
              <summary className="font-semibold cursor-pointer hover:text-[hsl(var(--primary))]">
                ❓ 모니터링 서비스가 시작되지 않습니다
              </summary>
